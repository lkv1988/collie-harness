...
try {
  ...
  process.stderr.write('[collie-harness/notification-escalate] Failed to parse stdin: ' + e.message + '\n');
}

const pluginRoot = process.env.CLAUDE_PLUGIN_ROOT;
if (!pluginRoot) {
  process.stderr.write('[collie-harness/notification-escalate] WARN: CLAUDE_PLUGIN_ROOT not set, skipping\n');
  process.exit(0);
}
